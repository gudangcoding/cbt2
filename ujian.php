...
echo '<h3 class="page-header">
		<b>
			Mapel: '.$rujian['nama_mapel'].' 
				<span class="pull-right"> Sisa Waktu: 
					<span class="menit">'.$sisa_waktu[0].'</span> : 
					<span class="detik"> '.$sisa_waktu[1].' </span>
				</span>
			</b>
		</h3>
   ...
   echo '</div>
   		<div class="col-md-4 col-md-offset-1">
   			<label class="btn btn-warning btn-block"> 
   				<input type="checkbox" autocomplete="off" onchange="ragu_ragu('.$no.')"> Ragu-ragu 
   			</label>
   		</div>	
   			...
   			<div class="modal-content">
   				<form  onsubmit="return selesai_ujian('.$_GET['ujian'].')">
					...
					<div class="modal-body">
	   					...
	   					<div class="chekbox-selesai">
	   						<input type="checkbox" required> Saya yakin akan menyelesaikan ujian.
	   					</div>
					</div>
			
					<div class="modal-footer">
		   				<button type="submit" class="btn btn-danger" onclick="return selesai_ujian('.$_GET['ujian'].')"> 
		   					Selesai 
		   				</button>
